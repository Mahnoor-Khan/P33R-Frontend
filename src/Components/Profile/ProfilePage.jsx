            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col md:flex-row gap-6 md:gap-20">
                ...
                <div className="flex gap-4 md:min-w-[332px] items-start">
                  <img src={userIcon} alt="first_name" />
                ...
                {/* Email */}
                <div className="flex gap-4 md:min-w-[332px] items-start">
                  <img src={emailIcon} alt="last_name" />
                  <div className="flex flex-col gap-1">
                    <p className="text-[#1F1C1E] font-Manrope text-base leading-normal font-bold">
                      Email Address
                    </p>
              ...
              <div className="flex flex-col md:flex-row gap-6 md:gap-20">
                {/* Last name */}
                <div className="flex gap-4 md:min-w-[332px] items-start">
                  <img src={userIcon} alt="last_name" />
                  <div className="flex flex-col gap-1">
                    <p className="text-[#1F1C1E] font-Manrope text-base leading-normal font-bold">
                      Last Name
                    </p>
                ...
                {/* Password */}
                <div className="flex gap-4 md:min-w-[332px] items-start">
                  <img src={passwordIcon} alt="last_name" />
                  <div className="flex flex-col gap-1">
                    <p className="text-[#1F1C1E] font-Manrope text-base leading-normal font-bold">
                      Password
                    </p>
              ...
              <div className="flex gap-4 items-start">
                <img src={phoneIcon} alt="last_name" />
                <div className="flex flex-col gap-1">
                  <p className="text-[#1F1C1E] font-Manrope text-base leading-normal font-bold">
                    Phone Number
                  </p>
