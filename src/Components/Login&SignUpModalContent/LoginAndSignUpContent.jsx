        ...
        <div className="flex flex-col gap-6 pt-6 border-t border-[#EBEBEB]">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-col gap-[2px]">
                    <div className="flex gap-1 items-center">
                      <img
                        src={eightCharacterPassword ? greenTick : redCross}
                        alt="_icon"
                      />
                      <p
                        className={`${
                    ...
                    <div className="flex gap-1 items-center">
                      <img
                        src={notNameAndEmail ? greenTick : redCross}
                        alt="_icon"
                      />
                      <p
                        className={`${
                    ...
                    <div className="flex gap-1 items-center">
                      <img
                        src={containSymOrNum ? greenTick : redCross}
                        alt="_icon"
                      />
                      <p
                        className={`${
          ...
          <div className="flex flex-col gap-4">
            <button className="flex gap-3 py-3 px-6 justify-center items-center rounded-[12px] border border-[#E0E0E0]">
              <img src={fbIcon} alt="_socialMedia" />
              <p className="text-[ #535052] font-manrope text-[14px]">
                Continue with Facebook
              </p>
            </button>
            <button className="flex gap-3 py-3 px-6 justify-center items-center rounded-[12px] border border-[#E0E0E0]">
              <img src={googleIcon} alt="_socialMedia" />
              <p className="text-[ #535052] font-manrope text-[14px]">
                Continue with Google
              </p>
            </button>
            <button className="flex gap-3 py-3 px-6 justify-center items-center rounded-[12px] border border-[#E0E0E0]">
              <img src={appleIcon} alt="_socialMedia" />
              <p className="text-[ #535052] font-manrope text-[14px]">
                Continue with Apple
              </p>
            </button>
