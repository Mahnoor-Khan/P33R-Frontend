...
function AboutProduct() {
  ...
  const imagesArray = [
    { id: 1, img: productDetailImd1 },
    { id: 2, img: productDetailImd2 },
    { id: 3, img: productDetailImd3 },
    { id: 4, img: productDetailImd4 },
    { id: 5, img: productDetailImd2 },
    { id: 6, img: productDetailImd1 },
    { id: 7, img: productDetailImd2 },
    { id: 8, img: productDetailImd3 },
    { id: 9, img: productDetailImd4 },
    { id: 10, img: productDetailImd2 },
    { id: 11, img: productDetailImd4 },
    { id: 12, img: productDetailImd1 },
    { id: 13, img: productDetailImd2 },
    { id: 14, img: productDetailImd3 },
    { id: 15, img: productDetailImd4 },
    { id: 16, img: productDetailImd1 },
  ];
      ...
      <div className="pt-[135px] flex flex-col gap-8 justify-center items-center">
        ...
        <div className="flex gap-3 flex-col sm:flex-row w-full">
          <div className="w-full sm:w-1/2">
            <img src={productDetailImd1} alt="pd" className=" w-full h-full" />
          </div>
          <div className="flex flex-col gap-3 w-full sm:w-1/2">
            <div className="flex flex-col sm:flex-row gap-3 w-full">
              <div className="w-full sm:w-1/2">
                <img
                  src={productDetailImd2}
                  alt="pd"
