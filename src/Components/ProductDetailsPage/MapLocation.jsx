  ...
  return (
    <>
      <div className="pt-12 pb-20 flex flex-col gap-8">
        {/* Map Heading */}
        <p className="text-start w-fit bg-gradient-to-r from-gradientBlue via-gradientLightBlue to-gradientPink bg-clip-text text-transparent text-center font-manrope text-xl font-medium">
          Map location
        </p>
