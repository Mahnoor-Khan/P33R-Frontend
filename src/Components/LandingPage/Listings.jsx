    ...
    <>
      <div className="px-4 md:px-6 flex flex-col gap-10">
        <div className="flex flex-col gap-20 justify-center items-center">
          ...
          <div className="flex flex-wrap gap-6 justify-center items-center">
            {cards.map((card, index) => (
              <div className="p-2 pb-4 rounded-2xl border border-[#EAEAEA]">
                <div className="flex flex-col gap-3">
                  <div className="flex flex-col pt-2">
                    <div className="flex gap-3 justify-end mb-[-40px] z-10 mr-3">
                      <img
                        src={card.fav ? pinkHeart : whiteHeart}
                        alt="_fav"
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex gap-6 justify-between items-start">
                      ...
                      <div className="flex gap-2">
                        <img src={startIcon} alt="_rate" />
                        <p className="text-[#1F1C1E] font-manrope text-sm font-medium">
                          {card.rating}
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-6 justify-between items-center justify-between">
        ...
        <div className="flex justify-center items-center gap-6">
          <img src={leftArrow} alt="_left" className="cursor-pointer" />
          <img src={rightArrow} alt="_right" className="cursor-pointer" />
        </div>
      </div>
    </>
  );
