    ...
    return (<>
        <div className="px-4 md:px-32 flex flex-col justify-center items-center gap-32 py-32">
            <div className="flex flex-col gap-12 justify-center items-center w-full">
                <div className=" flex gap-6 justify-between items-center w-full">
                    ...
                    <div className="flex gap-6">
                        <img onClick={() => handleScroll('left')} src={leftArrow} alt="_left" className='cursor-pointer'/>
                        <img onClick={() => handleScroll('right')} src={rightArrow} alt="_right" className='cursor-pointer'/>
                    </div>
                </div>
                <div className='flex gap-6 overflow-x-scroll noScrollBar w-full' ref={scrollContainer}>
                    {reviews.map(review => (
                        <div className='w-[358px] h-fit rounded-[20px] border border-[#E3E1E2] p-6 flex flex-col gap-5'>
            ...
            <div className='flex justify-center items-center'>
                <div className='flex flex-col xl:flex-row gap-6 xl:gap-32 px-6 md:px-24 pt-16 bg-no-repeat bg-cover rounded-[60px]' style={{ backgroundImage: `url(${serviceBg})` }}>
                    <div className='flex flex-col gap-10 pb-16'>
                        ...
                        <div className='flex gap-3 flex-wrap'>
                            <img src={appleBtn} alt="_apple" />
                            <img src={playstoreBtn} alt="_playstore" />
                        </div>
                    </div>
                    <img src={serviceImg} alt="_service" />
                </div>
            </div>
        </div>
    </>)
