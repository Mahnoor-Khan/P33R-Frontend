        ...
        {calledFrom === "landingPage" && (
          ...
          >
            <div className="text-[#212674] font-Manrope text-[45px] font-bold leading-normal flex justify-end">
              ...
              <img src={peerLogo} alt="_peer" className="mt-[73px]" />
            </div>
            <div className="flex flex-col gap-5">
              ...
              <div className="rounded-full bg-white p-2 pl-6 flex gap-6">
                ...
                <img className="sm:hidden" src={rightArrow} alt="_getStarted" />
              </div>
            </div>
          </div>
        )}
        <div className="flex flex-col">
          <div className="flex gap-24 justify-between flex-col lg:flex-row">
            <div className="flex flex-col gap-3">
              <img src={peerLogo} alt="_logo" className="w-32" />
              ...
              {footerMenus.map((menu) => (
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-2">
                    {menu.subHeadings.map((subHeading) => (
                      <p className="text-[#747073] font-Manrope text-base leading-tight">
                        {subHeading}
                      </p>
                    ))}
                  </div>
          ...
          <img src={bottomStyledBorder} alt="_border" />
