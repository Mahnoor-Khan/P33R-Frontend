    ...
    return (<>
        <div className="px-4 md:px-6 flex flex-col gap-32 py-32">
                ...
                <div className="flex flex-col gap-20">
                    <div className="flex flex-col lg:flex-row gap-12 justify-center items-center">
                        ...
                        <div className="flex gap-6 flex-col md:flex-row lg:flex-col xl:flex-row">
                            <img src={aboutImg1} alt="_about" />
                            <img src={aboutImg2} alt="_about" />
                        </div>
                    </div>
                    <div className='flex justify-center items-center w-full'>
                        <div className='flex flex-col md:flex-row justify-center items-center gap-6 md:gap-0'>
                            <img src={aboutImg3} alt="_about" className='md:w-[500px] md:h-[600px] lg:w-auto lg:h-auto' />
            ...
            <div className='flex justify-center items-center'>
                <div className='p-12 rounded-[60px] flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-32 bg-no-repeat bg-cover w-full lg:w-auto' style={{ backgroundImage: `url(${aboutBg})` }}>
