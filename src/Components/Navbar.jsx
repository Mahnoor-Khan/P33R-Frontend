...
function Navbar() {
  ...
  useEffect(() => {
    ...
    if (window.location.pathname === "/imageViewer") {
      setShowNavbar(false);
    } else {
      setShowNavbar(true);
    }
        ...
        <>
          ...
          >
            ...
            {showSearchBtn && (
              ...
              >
                <div className="flex gap-4 mb-[1px] mr-[0.5px] py-1 bg-white rounded-full bg-white p-1 pr-5 justify-center items-center">
                  {!whiteNavbar && <img src={searchIcon} alt="search" />}
                  <p
            ...
            <div
              ...
              className="cursor-pointer hidden md:flex cursor-pointer justify-center items-center p-1 pr-3 h-fit gap-3 border border-black rounded-full "
            >
              <img
                src={isUserLoggedin ? profilePic : profileIcon}
                alt="_profile"
              />
              {isUserLoggedin && (
              ...
              <img src={downArrow} alt="_dropdown" />
            </div>
            <FiMenu
                ...
                >
                  {dropdownData?.map((item) => (
                    <li>
                      <a
                        ...
                        href={item.href}
                        className="flex px-4 pb-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-[#1F1C1E] font-manrope text-base font-medium"
                      >
                        {item.name}
                      </a>
                    </li>
                  ...
                  <li>
                    <a
                      ...
                      href="#"
                      className="flex px-4 pt-4 border-t border-[#E3E1E2] hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white stext-[#1F1C1E] font-manrope text-base font-medium"
                    >
