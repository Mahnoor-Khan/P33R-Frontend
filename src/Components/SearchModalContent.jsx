...
function SearchModalContent({
    ...
    <div className="flex flex-col gap-4">
      <div className="p-6 flex flex-col gap-5">
        {guestsDropdownContent.map((item) => (
          <div className="flex gap-24 justify-between items-center flex-wrap">
  ...
  const categories = [
    {
      id: 1,
      img: searchCategoryImg1,
      name: "Places",
    },
    {
      id: 2,
      img: searchCategoryImg2,
      name: "Vehicles",
    },
    {
      id: 3,
      img: searchCategoryImg3,
      name: "Clothing",
    },
    {
      id: 4,
      img: searchCategoryImg4,
      name: "Boats",
    },
    {
      id: 5,
      img: searchCategoryImg5,
      name: "Tools",
    },
    {
      id: 6,
      img: searchCategoryImg6,
      name: "Camera",
    },
    {
      id: 7,
