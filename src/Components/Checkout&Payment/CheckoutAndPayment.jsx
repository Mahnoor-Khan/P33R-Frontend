  ...
  return (
    <>
      <div className="pt-[143px] pb-16 flex flex-col gap-12 items-center justify-center px-4 md:px-6 lg:px-20 xl:px-32">
        <p className=" text-start w-fit bg-gradient-to-r from-gradientBlue via-gradientLightBlue to-gradientPink bg-clip-text text-transparent text-center font-manrope text-2xl font-medium">
          Checkout & Payment
        </p>
        <div className="flex flex-col flex-col-reverse lg:flex-row gap-24 md:gap-20">
                    ...
                    <Select
                      ...
                      options={[
                        ...
                        },
                        {
                          ...
                          label: (
                            <div className="flex gap-3 items-center">
                              <img src={stripeIcon} alt="_stripe" />
                              <p className="text-[#747073] font-Manrope text-sm leading-normal">
                                Stripe
                              </p>
                            </div>
                        ...
                        },
                        {
                          ...
                          label: (
                            <div className="flex gap-3 items-center">
                              <img src={paypalIcon} alt="_paypal" />
                              <p className="text-[#747073] font-Manrope text-sm leading-normal">
                                Paypal
                              </p>
                            </div>
